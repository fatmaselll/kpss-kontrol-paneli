...
function renderTrialNotesList() {
    ...
    dersler.forEach(ders => {
        ...
        dersNotes.forEach(n => {
            ...
            box.innerHTML = `✅ Doğru: <b>${n.dogru}</b> | ❌ Yanlış: <b>${n.yanlis}</b> | ⭕ Boş: <b>${n.bos}</b> | 🧮 Net: <b>${n.net}</b> <span style='color:#888; font-size:0.97em; margin-left:10px;'>📅 ${n.tarih || ''} ⏰ ${n.saat || ''}</span>`;
